...
import com.dilip.jobsapp.presentation.home.JobsListView
...
fun BookmarkScreen(navHostController: NavHostController) {
    ...
    Column {
        ...
        JobsListView(bookmarks.value, onClick = {
            navHostController.navigate(NavRoute.createJobsDetailsRoute(it, true))
        })
    }
}